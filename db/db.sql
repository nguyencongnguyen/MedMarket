...
CREATE TABLE product (
  ...
  UP_TIME bigint(20) NOT NULL DEFAULT 0,
  UP_IP varchar(20) NULL,
...
CREATE TABLE image (
  ...
  CREATED_DATE datetime NOT NULL,
  UPDATE_DATE datetime NULL,
  INDEX PROD_IDX (PRODUCT_ID),
  CONSTRAINT IMGPROD FOREIGN KEY (PRODUCT_ID) REFERENCES product(PRODUCT_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  PRIMARY KEY (IMG_ID)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
